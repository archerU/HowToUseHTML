      ...
      <div>
        ...
        <div className={s.content}>
          <aside>
            ...
            <hr/>
            <h3>内联文本语义 31个标签</h3>
            <ol className={s.linestyle}>
              <li>a,abbr,bdi,bdo,b,em,strong,small,i,mark,u,sub,sup,span</li>
              <li>br,time,code,var,wbr</li>
              <li>cite,data,dfn,kbd,nobr,q,rp,rt,rtc,ruby,s,samp</li>
            </ol>
            <hr/>
            <h3>编辑标识 2个标签</h3>
            <ol className={s.linestyle}>
            ...
            <h3>交互元素 5个标签</h3>
            <dl>
              <dt className={s.linestyle}>details,summary,dialog,menu,menuitem</dt>
            </dl>
          </aside>
          <main>
            main 是独一无二的内容
